...
{-
--***************************** from  Idris2/src/Text/Parser/Core.idr
export
fatalError : String -> Grammar tok c ty
fatalError s = Fail s --True

--***************************** end of from  Idris2/src/Text/Parser/Core.idr
-}

--***************************** from  Idris2/src/Core/Options.idr 

public export
data LangExt = Borrowing -- not yet implemented

--***************************** end of from  Idris2/src/Core/Options.idr 
