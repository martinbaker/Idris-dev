...
idris -p contrib Parser/Lexer.idr
-}
...
processWhitespace : (List (TokenData Token), Int, Int, String)
...
export
lexAlg : String -> (List (TokenData Token), Int, Int, String)
lexAlg s = processWhitespace (lex rawTokens s)
